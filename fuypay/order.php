...
<input type="hidden" name="order_id" value="<?php echo date('YmdHis').rand(100000,999999);?>"/>
		...
		<table width="100%" border="0" cellspacing="1">
		 <tr>
		    ...
		    <td class="bg_yellow2" align="left"> &nbsp;
			    <input type="text" name="mchnt_cd" size='30' maxlength='15' value="0002900F1095078"/>
		  </tr>
		  <tr>
		  ...
		  <tr>
		    ...
		    <td class="bg_yellow2" 	align="left">&nbsp;&nbsp;<input type="text" name="ver"  size='30' maxlength='100' value='1.0.1'/></td>
		  </tr>
		  <tr>
