...
$order_date = $StringUtils->nvl($_REQUEST['order_date']);
$order_st = $StringUtils->nvl($_REQUEST['order_st']);
$order_pay_code = $StringUtils->nvl($_REQUEST['order_pay_code']);
$order_pay_error = $StringUtils->nvl($_REQUEST['order_pay_error']);
$fy_ssn = $StringUtils->nvl($_REQUEST['fy_ssn']);
$resv1 = $StringUtils->nvl($_REQUEST['resv1']);
$md5 = $StringUtils->nvl($_REQUEST['md5']);
